...
Future<WebSocket?> connectWebSoket() async {
  try {
    ...
    WebSocket socket = await WebSocket.connect(VehicleSignalConfig.s_uri,
        customClient: client);
    return socket;
  } catch (e) {
    print(e.toString());
...
final sockConnectprovider = FutureProvider((ref) => connectWebSoket());
